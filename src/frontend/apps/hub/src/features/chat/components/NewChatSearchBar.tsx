...
export const NewChatSearchBar = ({
  ...
  return (
    <header className="hub__new-chat-search" aria-label={t("New chat search")}>
      ...
      {onEncryptedChange && (
        // The consequences are permanent - no search, no way back - so they
        ...
        <label
          ...
          title={t(
            "Messages will be readable only by the participants. Search will not find them. This cannot be undone later.",
          )}
        >
          <input
            type="checkbox"
