...
urlpatterns = [
    ...
    path(
        "meetings/<str:slug>/documents/",
        viewsets.MeetingDocumentsView.as_view(),
    ...
    path(
        "meetings/<str:slug>/attachments/<uuid:attachment_id>/",
        viewsets.MeetingAttachmentView.as_view(),
